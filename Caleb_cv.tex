...
\item  Dominique Arion, {\bf Zhiguang Huo}, John F. Enwright, John P. Corradi, George Tseng and David A. Lewis.
...
\textbf{Lecture}
\begin{innerlist}
\item Lecture on BIOST2094 - Advanced R Computing \hfill Jan 2017
\item[] (6 lectures on Advanced R Computation)
\item Lecture on BIOST2025 - Special Studies in Bayesian Data Analysis \hfill Sep 2016
\item[] (4 lectures on Advanced Bayesian Computation)
\end{innerlist}
...
\begin{innerlist}
    ...
    \item Matlab (2 year),
    \item Python (1 year),
    \item Java, C++, C (1 year).
\end{innerlist}

\section{Running}
\begin{innerlist}
    \item Bank of America Chicago Marathon, Chicago, IL \hfill {10/09/2016}
    \item[] {\href{http://results.chicagomarathon.com/2016/?content=detail&fpid=search&pid=search&idp=999999107FA309000019B627&lang=EN_CAP&event=MAR&lang=EN_CAP&search\%5Bname\%5D=Huo&search\%5Bfirstname\%5D=Zhiguang&search_sort=name&search_event=MAR}{TIME 04:08:27}}       
