...
Submitted to \emph{Annals of Applied Statistics}.
    \item Li Zhu, Ying Ding, Cho-Yi Chen, Lin Wang, Zhiguang Huo, SungHwan Kim, Steffi Oesterreich and George C. Tseng. (2016)
...
Teaching assistant \hfill {Sep 2014 - Dec 2014}
\begin{innerlist}
\item[] BIOST 2078 - Introductory high-throughput genomic data analysis II: theories and algorithms\\
        with George C. Tseng\\
        Department of Biostatistics,\\
        University of Pittsburgh
\end{innerlist}

Teaching assistant \hfill {Jan 2012 - Apr 2012}
\begin{innerlist}
\item[] PHYS 0212 - Introduction to Laboratory Physics\\
        with Russell J. Clark\\
        Department of Physics and Astronomy,\\
        University of Pittsburgh
\end{innerlist}

Teaching assistant \hfill {Aug 2011 - Dec 2011}
\begin{innerlist}
\item[] PHYS 0212 - Introduction to Laboratory Physics\\
        with Russell J. Clark\\
        Department of Physics and Astronomy,\\
